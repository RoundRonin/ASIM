...
namespace Infrastructure.Migrations
{
    ...
    public partial class AutoMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Seed some default users into the "Users" table.
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Name", "Email", "PasswordHash", "Role", "LastLogin" },
                values: new object[,]
                {
                    { 1, "Alice Johnson", "alice@example.com", "hashed_password_1", "Admin", DateTime.UtcNow },
                    { 2, "Bob Smith", "bob@example.com", "hashed_password_2", "User", DateTime.UtcNow },
                    { 3, "Charlie Brown", "charlie@example.com", "hashed_password_3", "User", DateTime.UtcNow }
                });
